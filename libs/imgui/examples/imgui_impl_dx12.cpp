...
//  2018-12-03: Misc: Added #pragma comment statement to automatically link with d3dcompiler.libs when using D3DCompile().
...
#ifdef _MSC_VER
#pragma comment(libs, "d3dcompiler") // Automatically link with d3dcompiler.libs as we are using D3DCompile() below.
#endif
...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // By using D3DCompile() from <d3dcompiler.h> / d3dcompiler.libs, we introduce a dependency to a given version of d3dcompiler_XX.dll (see D3DCOMPILER_DLL_A)
